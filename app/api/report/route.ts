...
8. Season extrapolation: Does the report project a player's current-season stat to a "full season" total? Look for phrases like "across a full", "over a full season", "in a full season", "full 80-game", "full 82-game". If any appear, flag it.
