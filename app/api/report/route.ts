...
3. Dataset qualifier: Does any of these phrases appear: "in this data set", "in this dataset", "in this matchup's data", "lead all skaters in this data set", "in the data provided", "skaters in the data"?
...
6. Last-N arithmetic: For every "last N" record cited (e.g. "last ten", "last 10"), add W + L + OT. If the sum is not equal to N, flag it. Example: "6W-2L-1OT over his last ten" → 6+2+1=9 ≠ 10 → flag it.
